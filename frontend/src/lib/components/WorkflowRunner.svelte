...
{:else}
	...
	<div class="ldk-card ldk-status-panel" data-testid="workflow-status-log">
		...
		<p class="ldk-muted ldk-status-tip">
			...
			settings → allow <strong>local network</strong> for this site. (3) Try Edge or Firefox to compare. (4) Some PCs
			block this via Windows or browser policy — use another machine or ask IT to allow local network access from the
			browser for your GitHub Pages origin.
		</p>
