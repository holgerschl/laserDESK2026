...
/// JSON body: base_ip (string), netmask (string, e.g. 255.255.255.0), optional port (default 5020),
/// tgm_format (default 0), timeout_ms (default 120), max_hosts (default 512, cap 4096).
